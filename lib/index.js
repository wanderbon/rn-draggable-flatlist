...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.startAnimation = function(to, from) {
      ...
      startClock(_this.scaleClock);
      var runSrping = cond(
        clockRunning(_this.scaleClock),
        procs_1.springFill(_this.scaleClock, state, config)
      );
      set(_this.scale, runSrping);
      stopClock(_this.scaleClock);
    };
