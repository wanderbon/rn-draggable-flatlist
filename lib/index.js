  ...
  function DraggableFlatList(props) {
    ...
    _this.componentDidUpdate = function(prevProps, prevState) {
      return __awaiter(_this, void 0, void 0, function() {
        var layoutInvalidationKeyHasChanged,
          dataHasChanged,
          index,
          cellData,
        ...
        return __generator(this, function(_a) {
          ...
          currentHoverComponent = this.state.hoverComponent;
          prevHoverComponent = prevState.hoverComponent;
    ...
    _this.drag = function(hoverComponent, activeKey) {
      if (_this.state.hoverComponent) {
        ...
        _this.setState(
          ...
          function() {
            //run spring
            _this.generateTimingAnimation(true).start(function() {
    ...
    _this.generateTimingAnimation = function(isActive) {
      return react_native_reanimated_1.default.timing(_this.scale, {
        duration: 500,
    ...
    _this.onRelease = function(_a) {
      var index = _a[0];
      _this.generateTimingAnimation(false).start(function() {
