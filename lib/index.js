  ...
  function DraggableFlatList(props) {
    ...
    _this.scrollToAsync = function(offset) {
      return new Promise(function(resolve, reject) {
        ...
        console.log("activeIndex", _this.activeIndex.__getValue());
        // @ts-ignore: Unreachable code error for __getValue
        console.log("activeCellSize", _this.activeCellSize.__getValue());
        // @ts-ignore: Unreachable code error for __getValue
        console.log("isHovering", _this.isHovering.__getValue());
        cond(eq(_this.spacerIndex, -1), [
          call([new Value(offset)], _this.notScroll)
        ]);
        _this.scroll(offset);
      });
    };
    _this.notScroll = function(args) {
