  ...
  function DraggableFlatList(props) {
    ...
    _this.scrollToAsync = function(offset) {
      return new Promise(function(resolve, reject) {
        ...
        console.log("-1", _this.spacerIndex === new Value(-1));
        console.log("0", _this.spacerIndex === new Value(0));
        console.log("1", _this.spacerIndex === new Value(1));
        console.log("2", _this.spacerIndex === new Value(2));
        if (_this.spacerIndex !== new Value(-1)) {
          _this.scroll({ offset: offset });
        }
      });
    };
    _this.scroll = function(_a) {
      var offset = _a.offset;
      var flatlistRef = _this.flatlistRef.current;
      console.log("offset", offset);
      if (flatlistRef) flatlistRef.getNode().scrollToOffset({ offset: offset });
    };
