...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.renderItem = function(_a) {
      ...
      var isActiveRow = index === _this.keyToIndex.get(key);
  ...
  RowItem.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        {
          minDeltaY: 50,
          onGestureEvent: react_native_reanimated_1.default.event(
            [
              {
                nativeEvent: {
                  translationX: new react_native_reanimated_1.default.Value(0),
                  translationY: index
                    ? this._dragY
                    : new react_native_reanimated_1.default.Value(0)
                }
              }
            ],
            {
