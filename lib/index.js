...
var Value = react_native_reanimated_1.default.Value,
  ...
  timing = react_native_reanimated_1.default.timing;
var runSpringAnimation = function(clock, from, to) {
  var state = {
  ...
  var config = {
    ...
    easing: react_native_reanimated_1.Easing.inOut(
      react_native_reanimated_1.Easing.ease
    )
  };
  return block([
...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.hoverClock = new react_native_reanimated_1.Clock();
    ...
    _this.startAnimation = function(from, to) {
      var clock = new react_native_reanimated_1.Clock();
      set(_this.scale, runSpringAnimation(clock, from, to));
    };
