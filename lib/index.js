  ...
  function DraggableFlatList(props) {
    ...
    _this.scrollToAsync = function(offset) {
      return new Promise(function(resolve, reject) {
        var _a, _b, _c, _d, _e;
        var activeKey = _this.state.activeKey;
        var data = _this.cellData.get(activeKey || "");
        var cellSize =
          (_b =
            (_a =
              data === null || data === void 0 ? void 0 : data.measurements) ===
              null || _a === void 0
              ? void 0
        ...
        var currentIndex =
          (_e =
            data === null || data === void 0 ? void 0 : data.currentIndex) !==
            null && _e !== void 0
            ? _e
            : 1;
        // const stopOffset =
    ...
    _this.onScroll = event([
      {
        nativeEvent: function(_a) {
          ...
          return block([
            cond(
              greaterOrEq(
                contentOffset[_this.props.horizontal ? "x" : "y"],
                _this.activeCellSize
              ),
              set(
                _this.scrollOffset,
