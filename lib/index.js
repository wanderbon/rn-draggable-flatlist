...
var _a = react_native_1.Dimensions.get("screen"),
  height = _a.height,
  width = _a.width;
...
var debugGestureState = function(state, context) {
  var stateStr = Object.entries(react_native_gesture_handler_1.State).find(
    function(_a) {
      var k = _a[0],
        v = _a[1];
      return v === state;
  ...
  console.log(
    "## " + context + " debug gesture state: " + state + " - " + stateStr
  );
};
...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.scale = new react_native_reanimated_1.default.Value(0);
    _this.lastTimingAnimation = "";
    ...
    _this.startTimingAnimation = function() {
      if (_this.lastTimingAnimation !== "start") {
        _this.lastTimingAnimation = "start";
        react_native_reanimated_1.default
          .timing(_this.scale, {
            duration: 500,
            toValue: 1,
            easing: react_native_reanimated_1.Easing.bounce
          })
          .start();
      }
    };
    _this.endTimingAnimation = function() {
      if (_this.lastTimingAnimation !== "end") {
        _this.lastTimingAnimation = "end";
        react_native_reanimated_1.default
          .timing(_this.scale, {
            duration: 500,
            toValue: 0,
    ...
    _this.activateScroll = function(args) {
      console.log("activateScroll", args[0]);
      _this.canScroll = true;
    };
    _this.unactivateScroll = function(args) {
      console.log("unactivateScroll", args[0]);
      _this.canScroll = false;
    };
    _this.scroll = function(offset) {
    ...
    _this.checkAutoscroll = cond(
      and(
        ...
        not(_this.isAutoscrolling.native)
      ),
            ...
            [
              ...
              cond(
                ...
                set(
                  ...
                  sub(_this.touchAbsolute, _this.props.horizontal ? x : y)
                )
              ),
              cond(
                or(
        ...
        nativeEvent: function(_a) {
          ...
          return cond(
            ...
            [
              ...
              set(
                _this.touchAbsolute,
                add(_this.props.horizontal ? x : y, _this.activationDistance)
              )
            ]
          );
        }
    ...
    _this.renderHoverComponent = function() {
      ...
      var _b = _this.props,
        ...
        hoverComponentStyle = _b.hoverComponentStyle;
          ...
          style: [
              ...
              : styles.hoverComponentVertical,
            {
              ...
              transform: [
                ...
                (_a.scale = react_native_reanimated_1.interpolate(_this.scale, {
                  inputRange: [0, 1],
                  outputRange: [1, 1.1]
                })),
                _a)
    ...
    _this.renderItem = function(_a) {
      ...
      var _b = _this.props,
        ...
        horizontal = _b.horizontal,
        deleteItem = _b.deleteItem,
        screenHeight = _b.screenHeight,
      ...
      return react_1.default.createElement(RowItem, {
        ...
        draggablePanRef: _this.panGestureHandlerRef
      });
    };
  ...
  DraggableFlatList.prototype.render = function() {
    ...
    var _a = this.props,
      ...
      scrollEventThrottle = _a.scrollEventThrottle;
          ...
          function() {
            return block([
              ...
              onChange(
                ...
                cond(
                  or(
                    and(eq(_this.spacerIndex, 1), _this.isScrolledUp),
                    eq(_this.spacerIndex, -1)
                  ),
                  call([_this.spacerIndex], _this.unactivateScroll),
                  call([_this.spacerIndex], _this.activateScroll)
                )
              ),
              onChange(_this.hoverTo, call([_this.hoverTo], console.log))
            ]);
          }
        ),
