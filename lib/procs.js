...
exports.springFill = exports.setupCell = exports.hardReset = exports.getOnChangeTranslate = exports.getCellStart = exports.getIsAfterActive = void 0;
...
exports.setupCell = proc(function(
  ...
  return block([
    ...
    cond(and(isHovering, eq(spacerIndex, currentIndex)), [
      react_native_reanimated_1.call([offset], console.log),
      react_native_reanimated_1.call([new Value("------ OFFSET")], console.log),
      react_native_reanimated_1.call([scrollOffset], console.log),
      react_native_reanimated_1.call([new Value("------ SCROLL")], console.log),
      react_native_reanimated_1.call([activeCellSize], console.log),
      react_native_reanimated_1.call([new Value("------ ACTIVE")], console.log),
      react_native_reanimated_1.call([size], console.log),
      react_native_reanimated_1.call([new Value("------ SIZE")], console.log),
      set(
        hoverTo,
        sub(
          offset,
