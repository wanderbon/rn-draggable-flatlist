...
exports.setupCell = proc(function(
  ...
  return block([
    ...
    cond(and(isHovering, eq(spacerIndex, currentIndex)), [
      ...
      react_native_reanimated_1.call([spacerIndex], console.log),
      react_native_reanimated_1.call([new Value("------ SPACER")], console.log),
      react_native_reanimated_1.call([currentIndex], console.log),
